                ...
                <div className="mt-[30px] flex justify-between flex-wrap flex-col md:flex-row gap-[30px]">
                    <div className="flex items-start gap-[15px] w-[340px] max-w-full">
                        ...
                        <p className="font-normal text-sm tracking-[0.8]">
                            ...
                            Sunt ipsum explicabo et nobis dolore laudantium ex quam tempore maiores nulla?
                        </p>
                    </div>
                    <div>
                        {contact.map((item)=>{
                            return <div key={item.text} className="flex items-center gap-[15px] mb-[15px] last-of-type:mb-0">
